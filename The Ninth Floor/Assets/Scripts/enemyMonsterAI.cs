...
public class enemyMonsterAI : MonoBehaviour
{
    ...
    Vector3 dest; //the ai's destination
    public float chaseTime, idleTime; //how long the AI chase the player for, amount of time enemy is idle for
	...
	//after a set amount of seconds, enemy will start walking to a random destination again
